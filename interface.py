...
class Ui_batch_media_converter(object):
    def setupUi(self, batch_media_converter):
        ...
        self.verticalLayout_2.addLayout(self.input_directory_layout)
        ...
        self.verticalLayout_2.addLayout(self.output_directory_layout)
        ...
        self.vertical_layout_0.addWidget(self.input_format_label)
        self.input_format_combo = QtWidgets.QComboBox(self.centralwidget)
        self.input_format_combo.setObjectName("input_format_combo")
        self.vertical_layout_0.addWidget(self.input_format_combo)
        self.horizontal_layout_0.addLayout(self.vertical_layout_0)
        ...
        self.vertical_layout_1.addWidget(self.output_format_label)
        ...
        self.vertical_layout_1.addWidget(self.output_format_combo)
        self.horizontal_layout_0.addLayout(self.vertical_layout_1)
        self.verticalLayout_2.addLayout(self.horizontal_layout_0)
        ...
        self.verticalLayout_2.addWidget(self.skip_present_files_checkbox)
        ...
        self.verticalLayout_2.addWidget(self.files_completed_label)
        ...
        self.verticalLayout_2.addWidget(self.files_completed_progress)
        ...
        self.verticalLayout_2.addWidget(self.data_completed_label)
        ...
        self.verticalLayout_2.addWidget(self.data_completed_progress)
        ...
        self.verticalLayout_2.addWidget(self.current_processes_label)
        ...
        self.verticalLayout_2.addWidget(self.current_processes_list)
        ...
        self.verticalLayout_2.addLayout(self.actions_section_layout)
